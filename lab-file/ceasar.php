...
$github_link = "https://github.com/phucbm/lab-file/blob/master/ceasar.php";
...
<title>Mã hóa Ceasar</title>
<meta itemprop="image" content=" " />
<meta name="description" content="Với Ceasar, văn bản sẽ được mã hóa và giải mã bằng chìa khóa là một số tự nhiên mà ta nhập vào." />
<meta name="keywords" content="mã hóa ceasar, an ninh mạng, bmp, bui minh phuc, javascript">
...
<div class="main jumbotron">
  <h1 style="text-align:center">Mã hóa Ceasar</h1>
  <p style="text-align:center">Ngôn ngữ PHP. Hỗ trợ kí tự tiếng Anh thường, hoa và chữ số.</p>
</div>
